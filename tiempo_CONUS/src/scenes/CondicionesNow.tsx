  ...
  useEffect(() => {
    ...
    map.on("load", () => {
      ...
      const finish = () => {
        ...
        // anti-solape fuerte), como en los regionales: el placeBoxes antiguo dejaba
        // cajas en cascada (Chicago tapada por St. Paul). Los empujones manuales
        // NY/Houston/Seattle sobran: el sesgo al interior ya rotula tierra adentro.
