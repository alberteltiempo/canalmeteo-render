#!/bin/bash
# render.sh — Canal Meteo · Vistazo al Tiempo EEUU (MEDIO OESTE)
# ─────────────────────────────────────────────────────────────────────
# Renderiza el segmento MEDIO OESTE (auto-generado desde el CDN —satélite GOES,
# radar MRMS y vigilancias NWS— vía calculateMetadata), valida el MP4, lo
# sube al CDN y a Dropbox (/Playout/RenderFarm/TIEMPO_MW.mp4), y escribe
...
PROJECT_DIR="/opt/canalmeteo/remotion/tiempo_MW"
...
COMPOSITION="MwSegment"
SLUG="tiempo-mw"
DIRNAME="tiempo-mw"
DROPBOX_NAME="TIEMPO_MW.mp4"
LABEL="Vistazo al Tiempo EEUU · MEDIO OESTE (horizontal 1920×1080)"
...
# (/tmp/mw-render.lock) sigue evitando que se apilen MW con MW.
