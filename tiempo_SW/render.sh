#!/bin/bash
# render.sh — Canal Meteo · Vistazo al Tiempo EEUU (SUROESTE)
# ─────────────────────────────────────────────────────────────────────
# Renderiza el segmento SUROESTE (auto-generado desde el CDN —satélite GOES,
# radar MRMS y vigilancias NWS— vía calculateMetadata), valida el MP4, lo
# sube al CDN y a Dropbox (/Playout/RenderFarm/TIEMPO_SW.mp4), y escribe
...
PROJECT_DIR="/opt/canalmeteo/remotion/tiempo_SW"
...
COMPOSITION="SwSegment"
SLUG="tiempo-sw"
DIRNAME="tiempo-sw"
DROPBOX_NAME="TIEMPO_SW.mp4"
LABEL="Vistazo al Tiempo EEUU · SUROESTE (horizontal 1920×1080)"
...
# (/tmp/sw-render.lock) sigue evitando que se apilen SW con SW.
