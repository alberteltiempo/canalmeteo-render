...
# 2 y no 4: el trópico es el render más pesado (3 tormentas · ~19 escenas ·
# satélite global) y con 4 pestañas + un segmento del tiempo en paralelo los
# 12 GB de la máquina se agotan y Chrome congela/crashea páginas (2026-09-06).
CONCURRENCY=2
VERTICAL=false
