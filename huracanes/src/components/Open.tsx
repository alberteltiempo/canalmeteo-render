...
export const Open: React.FC = () => {
  ...
  // Espiral de fondo girando lento (motivo de ciclón)
  const spin = (frame / fps) * 18; // grados/seg

  // Fundido + ligero zoom de salida (encadena con el push-in del primer mapa)
  ...
  return (
    <AbsoluteFill
      style={{
        ...
        background: `radial-gradient(120% 120% at 50% 35%, ${BRAND.red} 0%, ${BRAND.redDeep} 60%, #3a0606 100%)`,
        justifyContent: "center",
        alignItems: "center",
      }}
    >
      {/* Espiral sutil tipo ciclón */}
