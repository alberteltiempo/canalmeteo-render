#!/bin/bash
# render.sh — Canal Meteo · Vistazo al Tiempo EEUU (FLORIDA)
# ─────────────────────────────────────────────────────────────────────
# Renderiza el segmento FLORIDA (auto-generado desde el CDN —satélite GOES,
# radar MRMS y vigilancias NWS— vía calculateMetadata), valida el MP4, lo
# sube al CDN y a Dropbox (/Playout/RenderFarm/TIEMPO_FL.mp4), y escribe
...
PROJECT_DIR="/opt/canalmeteo/remotion/tiempo_FL"
...
COMPOSITION="FlSegment"
SLUG="tiempo-fl"
DIRNAME="tiempo-fl"
DROPBOX_NAME="TIEMPO_FL.mp4"
LABEL="Vistazo al Tiempo EEUU · FLORIDA (horizontal 1920×1080)"
...
# (/tmp/fl-render.lock) sigue evitando que se apilen FL con FL.
