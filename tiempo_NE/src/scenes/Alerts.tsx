...
export const Alerts: React.FC<{
  ...
  // Solo alertas de la REGIÓN (por estado o por los estados del area_desc) y de
  // categoría conocida: el mapa y las cajas deben contar la misma realidad —
  // antes los polígonos pintaban warnings locales/de fuera y la tarjeta decía
  // "No hay alertas".
  ...
  // resumen esos avisos, para no decir "sin alertas" con el mapa pintado.
  ...
  // Polígonos: solo los que TOCAN la región (estados del areaDesc "Condado, XX; …")
  // y de categoría conocida — lo pintado y lo contado es lo mismo.
