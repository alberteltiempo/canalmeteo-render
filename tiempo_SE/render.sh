#!/bin/bash
# render.sh — Canal Meteo · Vistazo al Tiempo EEUU (SURESTE)
# ─────────────────────────────────────────────────────────────────────
# Renderiza el segmento SURESTE (auto-generado desde el CDN —satélite GOES,
# radar MRMS y vigilancias NWS— vía calculateMetadata), valida el MP4, lo
# sube al CDN y a Dropbox (/Playout/RenderFarm/TIEMPO_SE.mp4), y escribe
...
PROJECT_DIR="/opt/canalmeteo/remotion/tiempo_SE"
...
COMPOSITION="SeSegment"
SLUG="tiempo-se"
DIRNAME="tiempo-se"
DROPBOX_NAME="TIEMPO_SE.mp4"
LABEL="Vistazo al Tiempo EEUU · SURESTE (horizontal 1920×1080)"
...
# (/tmp/se-render.lock) sigue evitando que se apilen SE con SE.
