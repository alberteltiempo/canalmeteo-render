#!/bin/bash
# render.sh — Canal Meteo · Vistazo al Tiempo EEUU (LLANURAS DEL SUR)
# ─────────────────────────────────────────────────────────────────────
# Renderiza el segmento LLANURAS DEL SUR (auto-generado desde el CDN —satélite GOES,
# radar MRMS y vigilancias NWS— vía calculateMetadata), valida el MP4, lo
# sube al CDN y a Dropbox (/Playout/RenderFarm/TIEMPO_SP.mp4), y escribe
...
PROJECT_DIR="/opt/canalmeteo/remotion/tiempo_SP"
...
COMPOSITION="SpSegment"
SLUG="tiempo-sp"
DIRNAME="tiempo-sp"
DROPBOX_NAME="TIEMPO_SP.mp4"
LABEL="Vistazo al Tiempo EEUU · LLANURAS DEL SUR (horizontal 1920×1080)"
...
# (/tmp/sp-render.lock) sigue evitando que se apilen SP con SP.
