#!/bin/bash
# render.sh — Canal Meteo · Vistazo al Tiempo EEUU (NOROESTE)
# ─────────────────────────────────────────────────────────────────────
# Renderiza el segmento NOROESTE (auto-generado desde el CDN —satélite GOES,
# radar MRMS y vigilancias NWS— vía calculateMetadata), valida el MP4, lo
# sube al CDN y a Dropbox (/Playout/RenderFarm/TIEMPO_NW.mp4), y escribe
...
PROJECT_DIR="/opt/canalmeteo/remotion/tiempo_NW"
...
COMPOSITION="NwSegment"
SLUG="tiempo-nw"
DIRNAME="tiempo-nw"
DROPBOX_NAME="TIEMPO_NW.mp4"
LABEL="Vistazo al Tiempo EEUU · NOROESTE (horizontal 1920×1080)"
...
# (/tmp/nw-render.lock) sigue evitando que se apilen NW con NW.
